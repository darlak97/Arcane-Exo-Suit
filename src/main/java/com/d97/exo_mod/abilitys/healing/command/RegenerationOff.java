...
public final class RegenerationOff extends AbstractPlayerCommand {

    private final RegenerationState state;

    public RegenerationOff(
    ...
    protected void execute(
        ...
        boolean ok = state.disableFromPlayerRef(player);

        EventTitleUtil.showEventTitleToPlayer(
                player,
                Message.raw("Exo_Suit: Regeneration"),
                Message.raw(ok ? "Deactivated" : "Error"),
                true
        );
    }
}